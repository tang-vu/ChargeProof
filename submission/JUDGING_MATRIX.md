...
| Functional integration            | Official SDK proof generation, live precompile readiness check, target `verifyAndEmit`, resumable Gate 2 runner | worker/Gate 2 source, Gate 1 evidence                       | Official flow verified; custom tx pending funds  |
