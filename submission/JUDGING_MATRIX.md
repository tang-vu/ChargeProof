...
| Public repository                 | Clean monorepo and MIT license                                                                            | `[REPOSITORY_URL]`                                          | Human publish action pending                    |
| README                            | Problem, architecture, integration, evidence, security, setup, limitations, roadmap                       | `README.md`                                                 | Complete; URLs pending                          |
| Project deck/PDF URL              | Ten-slide source ready                                                                                    | `submission/DECK.md`                                        | PDF/upload human action pending                 |
